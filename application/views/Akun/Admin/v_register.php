...
>
  <head>
    ...
    <title>Register SekolahPro</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">SekolahPro</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Best School Management🚀</h4>
              <p class="mb-4">Make your school management more professional</p>

              <form id="formAuthentication" class="mb-3" action="akun/register" method="POST">
                <div class="mb-3">
                ...
                <input type="submit" class="btn btn-primary d-grid w-100" name="submit" value="Sign Up">
              </form>
